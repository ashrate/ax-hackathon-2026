---
name: main
description: "Use when preparing a KakaoPay Securities AX Talent War submission: finding public evidence, defining a real company or investor problem, designing a Codex plugin solution, drafting the 5 required answers, or validating the package."
---

# KakaoPay Securities AX Problem Solver

## 목적

카카오페이증권 또는 투자자가 겪는 실제 문제를 공개 자료로 입증하고, 그 문제를 해결하는 Codex 플러그인 제출물로 구체화한다.

## 발동 조건

다음 요청에서 사용한다.

- 카카오페이증권 트랙의 문제 후보, 공개 근거, 투자자 pain point, 운영 자동화 아이디어를 찾을 때
- 카카오페이증권 관련 Codex 플러그인의 작동 방식, 스킬 지침, README, 5문항 답변을 작성할 때
