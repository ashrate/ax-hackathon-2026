...
| 공식 뉴스룸 MD 인터뷰는 무신사 MD가 브랜드와 고객을 연결하고, 트렌드를 살피며 브랜드 성장 기회를 제안한다고 설명한다. | 4 | https://newsroom.musinsa.com/newsroom-menu/2022-0216-md-10 | 2026-07-09 | `curl -L` 200 및 원문 구절 확인. 채용공고 213276은 심사자 시뮬레이션에서 curl 기준 403으로 지적되어 핵심 근거에서 제외. | 보강. 접근 가능한 공식 인터뷰 근거로 사용한다. |
...
| SIYAZU는 공식 사이트에서 미니멀 여성복 상품 전개가, 29CM 브랜드 페이지에서 "도시 여성의 사회적 역할을 지지"하는 포지션이 확인된다. | 4 | https://en.siyazu.co.kr/, https://shop.29cm.co.kr/brand/10005 | 2026-07-08 | 고객 반응 수치 부족으로 모니터링에 둔다. |
| LE17SEPTEMBRE는 공식 브랜드 페이지와 공식 컬렉션 페이지(RESORT/SS 2026)가 확인된다. 29CM 단독 콘텐츠 URL은 본문 자동 확인이 안 돼 화면 확인 대상이다. | 4 | https://le17septembre.com/about.html, https://en.le17septembre.com/, https://content.29cm.co.kr/brand-event/2026/06/01/2nd | 2026-07-08 | 정량 반응과 29CM 콘텐츠 화면 확인 전까지 모니터링에 둔다. |
